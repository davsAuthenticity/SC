...
<body>
	...
	<script>
	    ...
	    $(document).ready(function(){
	        ...
	        const redirect_uri = "https://psyched-edge-235319.appspot.com/drive"; 
	        const client_secret = "Tez7G1ip6REaJZiWSbm62CXl"; 
	        const scope = "https://www.googleapis.com/auth/drive";
	        var access_token= "";
	        var client_id = "619431868263-vekp7678mh01g7s0fn2p7rgasvhdc2vs.apps.googleusercontent.com";
	    ...
	    {
	    	//alert(viewLink+ " from saveDriveData " + downLink);
	    	var url = "https://psyched-edge-235319.appspot.com?vl="+viewLink+"&dl="+downLink;
