			...
			<div class="scan-area">
				...
				<div class="send-area">
					...
					<div class="decode">
						...
						<br>
						<label>Email</label>&nbsp;<input type="text" id="txtRecepEmail" name="txtRecepEmail" class="sender-details">
					</div>
					<div class="decode-right">
						<button id="sendemail" onclick="sendMail();" class="send-email">Send</button>
					</div>
				</div>
			</div>
		</div>
